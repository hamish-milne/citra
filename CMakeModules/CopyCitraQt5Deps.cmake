function(copy_citra_Qt5_deps target_dir)
    ...
    if (MSYS)
        set(Qt5_DLL_DIR "${MSYS_DIR/bin")
        set(Qt5_PLUGIN_DIR "${MSYS_DIR}/share/qt5/plugins")
    else()
        set(Qt5_DLL_DIR "${Qt5_DIR}/../../../bin")
        set(Qt5_PLUGIN_DIR "${Qt5_DIR}/../../../plugins")
    endif()
    set(Qt5_PLATFORMS_DIR "${Qt5_PLUGIN_DIR}/platforms/")
    set(Qt5_MEDIASERVICE_DIR "${Qt5_PLUGIN_DIR}/mediaservice/")
    set(Qt5_STYLES_DIR "${Qt5_PLUGIN_DIR}/styles/")
    set(Qt5_IMAGEFORMATS_DIR "${Qt5_PLUGIN_DIR}/imageformats/")
